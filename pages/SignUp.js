        ...
        <div className={'bg-white rounded-xl p-5 m-5 w-5/6 h-fit flex flex-col items-center justify-center shadow-lg'}>
          ...
          <div className={'w-full m-2 pl-5 pr-5 flex flex-row justify-between'}>
            <label className={'text-orange-500'}>
              <input className={'m-2'} type={'radio'} name={'radio'} value={'Owner'}/>
              Owner
            </label>
            <label>
              <input className={'m-2'} type={'radio'} name={'radio'} value={'Driver'}/>
              Driver
            </label>
            <label className={'text-blue-500'}>
              <input className={'m-2'} type={'radio'} name={'radio'} value={'Rider'}/>
              Rider
            </label>
          </div>
